...
``ThreadPool``类的一个普通用法就是不用设置每个线程的属性而启动多个独立的任务。例：微软例子：
...
![](https://raw.githubusercontent.com/xieguigang/xieguigang.github.io-hexo/master/images/vbnet/threadpool/20160616102020879.png)
